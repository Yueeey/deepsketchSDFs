...
def main_function(experiment_directory, continue_from):
    ...
    sdf_dataset = lib.data.RGBA2SDF_mask(
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        for sdf_data, image, sil, intrinsic, extrinsic, name in sdf_loader:
        ...
        for sdf_data, image, sil, intrinsic, extrinsic, name in sdf_loader_test:
